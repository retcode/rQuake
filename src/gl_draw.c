...
cvar_t		gl_anisotropy = {"gl_anisotropy", "16", true};
...
#endif
float		gl_max_anisotropy = 1.0f;  // Max supported by GPU
...
int		gl_filter_min = GL_LINEAR_MIPMAP_LINEAR;  // Trilinear filtering default
...
texels += scaled_width * scaled_height;
	...
	{
		float aniso = gl_anisotropy.value;
